...
import com.devhighlevel.application.exceptions.AuthorizationException
...
fun Application.statusPages() {
    install(StatusPages) {
        ...
        exception<AwsException> { call, throwable ->
            respond(
                call,
                HttpStatusCode.ExpectationFailed,
                HttpStatusCode.ExpectationFailed.description,
                throwable,
                throwable.message
            )
        }
